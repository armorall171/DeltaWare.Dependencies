...
{
    public interface IReadOnlyDependencyCollection : ICloneable
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns a <see cref="bool"/> specifying if the <see cref="IReadOnlyDependencyCollection"/> contains the specified type.
        /// </summary>
